    ...
    <div class="relative pt-32 pb-24 lg:pt-40 lg:pb-32 overflow-hidden min-h-screen">
        ...
        <div class="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
            ...
            <x-ui.glass-card class="animate-fade-in-up" style="animation-delay: 0.2s;" hoverEffect="false">
                <form action="{{ route('acquisition.store') }}" method="POST" class="space-y-6">
                    @csrf
                    ...
                    <div class="pt-4 flex items-center justify-between">
                        ...
                        <button type="submit" class="inline-flex items-center justify-center px-8 py-3 text-sm font-semibold rounded-full bg-cyan-500 text-white hover:bg-cyan-400 hover:shadow-[0_0_20px_rgba(6,182,212,0.4)] transition-all duration-300 transform hover:-translate-y-0.5">
                            Submit Inquiry
                        </button>
                    </div>
                </form>
